...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-VFOC9M4h.mjs");
...
var manifest = {
	"27a12dc5843fc434c662bf9e95bf70f9de70d24b7c54841f00e5046d4cba75ae": {
		functionName: "loginAdmin_createServerFn_handler",
		importer: () => import("./api-aq_fha3p.mjs")
	},
	"3aee11771751c59ffeb3c4f262e91a82a2c4782a9347d4e0bab3b6d830093f83": {
		functionName: "askAssistant_createServerFn_handler",
		importer: () => import("./api-aq_fha3p.mjs")
	},
	"9bd1b4b0d30a67bd55fef9af1a8d277ad8992334ed22affe0425c7485e3e8e53": {
		functionName: "listYoklama_createServerFn_handler",
		importer: () => import("./api-aq_fha3p.mjs")
	},
	"e79aeda53f2b51e46dbf87b61cf2b5207bdfb62a3cc3e276d8388bda1ec980b2": {
		functionName: "submitYoklama_createServerFn_handler",
		importer: () => import("./api-aq_fha3p.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-4d2op6tb.mjs").then((n) => n.t),
